...
public class PreviewDiff extends PreviewAbstract {
    ...
    private PreviewDiff(final PreviewDiffParameters input, PreparationDTO preparation,
            List<Action> lastActiveStepActions, List<Action> previewStepActions) {
    ...
    protected InputStream run() throws Exception {
        ...
        steps.stream().filter(step -> previewActionsIterator.hasNext()).forEach(
                step -> previewActions.put(step, previewActionsIterator.next()));
