...
public interface DatasetActions {
    ActionSettings DATASET_PREPARATIONS = ActionDropdownSettings.dropdownBuilder()
    ...
    ActionSettings DATASET_DISPLAY_MODE = ActionSettings.builder()
    ...
    ActionSettings DATASET_OPEN = ActionSettings.builder()
            .id("dataset:open")
            .name("Open dataset")
            .type("@@dataset/OPEN")
            .build();

    ActionSettings DATASET_SORT = ActionSettings.builder()
            .id("dataset:sort")
    ...
    ActionSettings DATASET_SUBMIT_EDIT = ActionSettings.builder()
            .id("dataset:submit-edit")
            .name("Submit name edition")
            .type("@@dataset/SUBMIT_EDIT")
            .build();

    ActionSettings DATASET_REMOVE = ActionSettings.builder()
            .id("dataset:remove")
            .name("Remove dataset")
            .icon("talend-trash")
            .type("@@dataset/REMOVE")
    ...
    ActionSettings DATASET_CLONE = ActionSettings.builder()
            .id("dataset:clone")
            .name("Copy dataset")
            .icon("talend-files-o")
            .type("@@dataset/CLONE")
    ...
    ActionSettings DATASET_FAVORITE = ActionSettings.builder()
            .id("dataset:favorite")
    ...
    ActionSettings DATASET_UPDATE = ActionSettings.builder()
            .id("dataset:update")
            .name("Update dataset")
    ...
    ActionSettings DATASET_FETCH = ActionSettings.builder()
            .id("datasets:fetch")
    ...
    ActionSettings DATASET_CREATE = ActionSplitDropdownSettings.splitDropdownBuilder()
            .id("dataset:create")
            .name("Add Dataset")
            .icon("talend-plus")
            .type("@@dataset/CREATE")
