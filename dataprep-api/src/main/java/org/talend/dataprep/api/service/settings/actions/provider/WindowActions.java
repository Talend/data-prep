...
public interface WindowActions {
    ActionSettings ONBOARDING_PREPARATION = ActionSettings.builder()
    ...
    ActionSettings MODAL_ABOUT = ActionSettings.builder()
            .id("modal:about")
    ...
    ActionSettings MODAL_FEEDBACK = ActionSettings.builder()
            .id("modal:feedback")
    ...
    ActionSettings EXTERNAL_HELP = ActionSettings.builder()
            .id("external:help")
    ...
    ActionSettings EXTERNAL_DOCUMENTATION = ActionSettings.builder()
