...
const RecipeKnot = {
    ...
    <div class="knot"
        ...
        ng-mouseleave="$ctrl.onHoverEnd()">
            ...
            <div 
            	ng-if="$ctrl.inactive" 
            	class="circle inactive-knot" 
            	ng-class="{'to-be-activated': $ctrl.toBeSwitched}"
            	title="{{::'ENABLE_STEP' | translate }}"></div>
            <div 
            	ng-if="!$ctrl.inactive" 
            	class="circle" 
            	ng-class="{'to-be-deactivated': $ctrl.toBeSwitched}"
            	title="{{::'DISABLE_STEP' | translate }}"></div>
