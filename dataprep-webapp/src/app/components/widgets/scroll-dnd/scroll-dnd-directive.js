...
/**
 * @ngdoc directive
 * @name data-prep.scroll-dnd.directive:ScrollDnd
 ...
 * @param {Number}  eventClientY the Y position of the mouse
 ...
 * @param {Boolean} isDragStart when true launches the periodic loop to scroll the element
 */
export default function ScrollDnd() {
	'ngInject';
	return {
		restrict: 'A',
