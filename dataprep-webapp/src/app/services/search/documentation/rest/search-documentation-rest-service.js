...
class SearchDocumentationRestService {
	...
	constructor($q, $http, documentationSearchURL) {
		'ngInject';
		this.$http = $http;
		this.$q = $q;
	...
	search(keyword) {
		...
		//};
		//return this.$http({
		//	url: 'https://talend-rc.fluidtopics.net/api/khub/maps/search',
		//	data: parameters,
		//	headers: {
		//		'FT-Authorization': 'Basic dGFsZW5kLWFwcHNAZmx1aWR0b3BpY3MuY29tOnRlc3RUTEQwMQ==',
