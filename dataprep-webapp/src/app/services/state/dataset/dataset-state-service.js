...
export function DatasetStateService($translate, ProgressStateService, PROGRESS_SCHEMAS) {
	'ngInject';
	...
	function startUploadingDataset(dataset) {
		...
		ProgressStateService.start(PROGRESS_SCHEMAS.DATASET, () => dataset.progress);
	}
