...
final class DataSetDataReader {
     ...
     */
    Map<String, DataSetRow> parseAndMapLookupDataSet(InputStream inputStream, String joinOnColumn) throws IOException {
    ...
    private Map<String, DataSetRow> parseRecords(JsonParser jsonParser, RowMetadata rowMetadata, String joinOnColumn)
        ...
        try {
            ...
            while (mapIterator.hasNext()) {
                ...
                DataSetRow row = new DataSetRow(rowMetadata, recordMap);
